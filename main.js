$(document).ready(function(){
    ...
    $("a").on('click', function(event) {
      ...
      // Asegura de que this.hash tenga un valor antes de anular el comportamiento predeterminado
      if (this.hash !== "") {
        // Evita el comportamiento de clic de anclaje predeterminado
        event.preventDefault();
  
        // Almacena la variable hash
        var hash = this.hash;
  
        // Uso el método animate() de jQuery para agregar desplazamiento de página suave
